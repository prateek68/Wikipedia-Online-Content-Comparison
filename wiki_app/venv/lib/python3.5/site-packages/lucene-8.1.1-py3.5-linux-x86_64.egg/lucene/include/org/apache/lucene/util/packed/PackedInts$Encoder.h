      ...
      namespace util {
        namespace packed {
          ...
          class PackedInts$Encoder : public ::java::lang::Object {
           public:
            enum {
              mid_byteBlockCount_ebe7ab370a509c13,
              mid_byteValueCount_ebe7ab370a509c13,
              mid_encode_94e7ae88a6ce1d4b,
              mid_encode_6655ca58566ba897,
              mid_encode_5710959229ac3236,
              mid_encode_9c299998f0242de3,
              mid_longBlockCount_ebe7ab370a509c13,
              mid_longValueCount_ebe7ab370a509c13,
              max_mid
            };
