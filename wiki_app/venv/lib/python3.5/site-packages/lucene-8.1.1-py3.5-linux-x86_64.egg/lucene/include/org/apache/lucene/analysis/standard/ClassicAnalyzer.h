          ...
          class ClassicAnalyzer : public ::org::apache::lucene::analysis::StopwordAnalyzerBase {
           public:
            enum {
              ...
              mid_init$_27bffdfab90e8f9d,
              mid_init$_4fd8e3a5e4256fa5,
              mid_getMaxTokenLength_ebe7ab370a509c13,
              mid_setMaxTokenLength_36df8fa8e39fb5cc,
              mid_createComponents_f24880e635cbdbf8,
              mid_normalize_0c7ab2510ceda208,
              max_mid
            };
