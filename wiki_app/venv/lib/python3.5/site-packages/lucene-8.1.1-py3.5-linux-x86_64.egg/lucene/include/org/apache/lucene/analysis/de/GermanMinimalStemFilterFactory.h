    ...
    namespace lucene {
      namespace analysis {
        namespace de {
          ...
          class GermanMinimalStemFilterFactory : public ::org::apache::lucene::analysis::util::TokenFilterFactory {
           public:
            enum {
            ...
            explicit GermanMinimalStemFilterFactory(jobject obj) : ::org::apache::lucene::analysis::util::TokenFilterFactory(obj) {
              if (obj != NULL && mids$ == NULL)
                env->getClass(initializeClass);
            }
            GermanMinimalStemFilterFactory(const GermanMinimalStemFilterFactory& obj) : ::org::apache::lucene::analysis::util::TokenFilterFactory(obj) {}
