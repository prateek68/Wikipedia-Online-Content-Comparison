...
namespace java {
  namespace util {
    ...
    class Map$Entry : public ::java::lang::Object {
     public:
      enum {
        mid_comparingByKey_b48d249fac7e0652,
        mid_comparingByKey_dcd3222898119b69,
        mid_comparingByValue_b48d249fac7e0652,
        mid_comparingByValue_dcd3222898119b69,
        mid_equals_95c645439e1de637,
        mid_getKey_23bf5655193fd7ea,
        mid_getValue_23bf5655193fd7ea,
        mid_hashCode_ebe7ab370a509c13,
        mid_setValue_f4977fb7b1cd4abc,
        max_mid
      };
