  ...
  namespace tartarus {
    namespace snowball {
      namespace ext {
        ...
        class ArmenianStemmer : public ::org::tartarus::snowball::SnowballProgram {
         public:
          enum {
          ...
          explicit ArmenianStemmer(jobject obj) : ::org::tartarus::snowball::SnowballProgram(obj) {
            if (obj != NULL && mids$ == NULL)
              env->getClass(initializeClass);
          }
          ArmenianStemmer(const ArmenianStemmer& obj) : ::org::tartarus::snowball::SnowballProgram(obj) {}
