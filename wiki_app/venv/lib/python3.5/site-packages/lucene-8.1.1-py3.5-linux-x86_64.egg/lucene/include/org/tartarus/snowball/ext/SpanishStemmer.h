  ...
  namespace tartarus {
    namespace snowball {
      namespace ext {
        ...
        class SpanishStemmer : public ::org::tartarus::snowball::SnowballProgram {
         public:
          enum {
          ...
          explicit SpanishStemmer(jobject obj) : ::org::tartarus::snowball::SnowballProgram(obj) {
            if (obj != NULL && mids$ == NULL)
              env->getClass(initializeClass);
          }
          SpanishStemmer(const SpanishStemmer& obj) : ::org::tartarus::snowball::SnowballProgram(obj) {}
