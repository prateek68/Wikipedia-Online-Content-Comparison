    ...
    namespace lucene {
      namespace analysis {
        namespace shingle {
          ...
          class FixedShingleFilterFactory : public ::org::apache::lucene::analysis::util::TokenFilterFactory {
           public:
            enum {
            ...
            explicit FixedShingleFilterFactory(jobject obj) : ::org::apache::lucene::analysis::util::TokenFilterFactory(obj) {
              if (obj != NULL && mids$ == NULL)
                env->getClass(initializeClass);
            }
            FixedShingleFilterFactory(const FixedShingleFilterFactory& obj) : ::org::apache::lucene::analysis::util::TokenFilterFactory(obj) {}
