        ...
        namespace bkd {
          ...
          class BKDReader$IntersectState : public ::java::lang::Object {
           public:
            ...
            BKDReader$IntersectState(const ::org::apache::lucene::store::IndexInput &, jint, jint, jint, jint, const ::org::apache::lucene::index::PointValues$IntersectVisitor &, const ::org::apache::lucene::util::bkd::BKDReader$IndexTree &);
          };
        }
      }
    }
