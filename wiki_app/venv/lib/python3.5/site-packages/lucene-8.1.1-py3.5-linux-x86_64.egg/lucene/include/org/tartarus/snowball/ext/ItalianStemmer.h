  ...
  namespace tartarus {
    namespace snowball {
      namespace ext {
        ...
        class ItalianStemmer : public ::org::tartarus::snowball::SnowballProgram {
         public:
          enum {
          ...
          explicit ItalianStemmer(jobject obj) : ::org::tartarus::snowball::SnowballProgram(obj) {
            if (obj != NULL && mids$ == NULL)
              env->getClass(initializeClass);
          }
          ItalianStemmer(const ItalianStemmer& obj) : ::org::tartarus::snowball::SnowballProgram(obj) {}
