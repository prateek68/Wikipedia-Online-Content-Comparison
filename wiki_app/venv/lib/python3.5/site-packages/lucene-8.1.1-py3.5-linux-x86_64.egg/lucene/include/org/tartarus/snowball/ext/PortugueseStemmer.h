  ...
  namespace tartarus {
    namespace snowball {
      namespace ext {
        ...
        class PortugueseStemmer : public ::org::tartarus::snowball::SnowballProgram {
         public:
          enum {
            mid_init$_8e1955e8a9db094a,
            mid_equals_95c645439e1de637,
            mid_hashCode_ebe7ab370a509c13,
            mid_stem_b61c635e27ed4ce7,
            max_mid
          };
          ...
          explicit PortugueseStemmer(jobject obj) : ::org::tartarus::snowball::SnowballProgram(obj) {
            if (obj != NULL && mids$ == NULL)
              env->getClass(initializeClass);
          }
          PortugueseStemmer(const PortugueseStemmer& obj) : ::org::tartarus::snowball::SnowballProgram(obj) {}
