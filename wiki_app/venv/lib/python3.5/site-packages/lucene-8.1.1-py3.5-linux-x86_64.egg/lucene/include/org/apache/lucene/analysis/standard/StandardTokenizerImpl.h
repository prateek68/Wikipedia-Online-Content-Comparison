      ...
      namespace analysis {
        namespace standard {
          ...
          class StandardTokenizerImpl : public ::java::lang::Object {
           public:
            enum {
              mid_init$_4fd8e3a5e4256fa5,
              mid_getNextToken_ebe7ab370a509c13,
              mid_getText_ba262df4f56bbed1,
              mid_setBufferSize_36df8fa8e39fb5cc,
              mid_yybegin_36df8fa8e39fb5cc,
              mid_yychar_ebe7ab370a509c13,
              mid_yycharat_cb77cd15fd3c4542,
              mid_yyclose_8e1955e8a9db094a,
              mid_yylength_ebe7ab370a509c13,
              mid_yypushback_36df8fa8e39fb5cc,
              mid_yyreset_4fd8e3a5e4256fa5,
              mid_yystate_ebe7ab370a509c13,
              mid_yytext_a59eabb26a802fa9,
              max_mid
            };
