    ...
    namespace lucene {
      namespace util {
        ...
        class VirtualMethod : public ::java::lang::Object {
         public:
          enum {
            mid_init$_b4afe67be3d39353,
            mid_compareImplementationDistance_5ce5c29a681a6d41,
            mid_getImplementationDistance_2f53bf3f7836a6e8,
            mid_isOverriddenAsOf_8971b9d5e299bf35,
            max_mid
          };
