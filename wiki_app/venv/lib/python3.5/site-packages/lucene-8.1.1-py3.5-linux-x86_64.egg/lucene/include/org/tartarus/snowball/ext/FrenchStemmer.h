  ...
  namespace tartarus {
    namespace snowball {
      namespace ext {
        ...
        class FrenchStemmer : public ::org::tartarus::snowball::SnowballProgram {
         public:
          enum {
          ...
          explicit FrenchStemmer(jobject obj) : ::org::tartarus::snowball::SnowballProgram(obj) {
            if (obj != NULL && mids$ == NULL)
              env->getClass(initializeClass);
          }
          FrenchStemmer(const FrenchStemmer& obj) : ::org::tartarus::snowball::SnowballProgram(obj) {}
