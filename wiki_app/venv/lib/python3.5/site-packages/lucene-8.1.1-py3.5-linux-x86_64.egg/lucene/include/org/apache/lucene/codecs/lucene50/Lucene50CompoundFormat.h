          ...
          class Lucene50CompoundFormat : public ::org::apache::lucene::codecs::CompoundFormat {
           public:
            enum {
              ...
              mid_getCompoundReader_7d7ddc7af19b6604,
              mid_write_6cf56fb8b1802f07,
              max_mid
            };
            ...
            ::org::apache::lucene::store::Directory getCompoundReader(const ::org::apache::lucene::store::Directory &, const ::org::apache::lucene::index::SegmentInfo &, const ::org::apache::lucene::store::IOContext &) const;
