  ...
  namespace tartarus {
    namespace snowball {
      namespace ext {
        ...
        class LovinsStemmer : public ::org::tartarus::snowball::SnowballProgram {
         public:
          enum {
          ...
          explicit LovinsStemmer(jobject obj) : ::org::tartarus::snowball::SnowballProgram(obj) {
            if (obj != NULL && mids$ == NULL)
              env->getClass(initializeClass);
          }
          LovinsStemmer(const LovinsStemmer& obj) : ::org::tartarus::snowball::SnowballProgram(obj) {}
